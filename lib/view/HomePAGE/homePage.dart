    ...
    return DefaultTabController(
      ...
      child: Scaffold(
        ...
        appBar: AppBar(
          ...
          actions: [Icon(Icons.grid_view_outlined, color: Colors.white)],
          // bottom: const TabBar(
                        ...
                        child: Padding(
                          ...
                          child: Container(
                            ...
                            decoration: BoxDecoration(
                              ...
                              // color: Colors.pink,
                              image: DecorationImage(
                                  image: NetworkImage(newsController2.teslaModal
                                      .value!.articles[0].urlToImage),
                                  fit: BoxFit.cover,
                                  opacity: 6.10),
                            ),
                              ...
                              children: [
                                Padding(
                                  ...
                                  child: Text(
                                    textAlign: TextAlign.start,
                                    newsController2
                                        .teslaModal.value!.articles[0].author,
                                    style: TextStyle(
                                        color: Colors.white,
                                        fontSize: 23,
                                        shadows: [
